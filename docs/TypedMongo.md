...
[tests](https://github.com/AVSystem/scala-commons/blob/1.x/commons-mongo/src/test/scala/com/avsystem/commons/mongo/typed/MongoRefTest.scala).
...
[tests](https://github.com/AVSystem/scala-commons/blob/1.x/commons-mongo/src/test/scala/com/avsystem/commons/mongo/typed/MongoFilterTest.scala).
...
For more examples, see the Scaladoc or
[tests](https://github.com/AVSystem/scala-commons/blob/1.x/commons-mongo/src/test/scala/com/avsystem/commons/mongo/typed/MongoProjectionTest.scala).
...
For more examples, see the Scaladoc or
[tests](https://github.com/AVSystem/scala-commons/blob/1.x/commons-mongo/src/test/scala/com/avsystem/commons/mongo/typed/MongoOrderTest.scala).
...
For more examples, see the Scaladoc or
[tests](https://github.com/AVSystem/scala-commons/blob/1.x/commons-mongo/src/test/scala/com/avsystem/commons/mongo/typed/MongoUpdateTest.scala).
...
For more examples, see the Scaladoc or
[tests](https://github.com/AVSystem/scala-commons/blob/1.x/commons-mongo/src/test/scala/com/avsystem/commons/mongo/typed/MongoIndexTest.scala).
...
[tests](https://github.com/AVSystem/scala-commons/blob/1.x/commons-mongo/src/test/scala/com/avsystem/commons/mongo/typed/TypedMongoCollectionTest.scala).
