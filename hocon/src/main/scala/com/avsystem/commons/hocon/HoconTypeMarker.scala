...
/**
 * [[com.avsystem.commons.serialization.TypeMarker TypeMarker]] which allows direct reading of a `Duration` from
 * [[HoconInput]] in a [[com.avsystem.commons.serialization.GenCodec GenCodec]] implementation, taking advantage of the
 * [[https://github.com/lightbend/config/blob/master/HOCON.md#duration-format recommended HOCON format for durations]],
 * implemented by `Config.getDuration`.
 */
object DurationMarker extends HoconTypeMarker[Duration]

/**
 * [[com.avsystem.commons.serialization.TypeMarker TypeMarker]] which allows direct reading of a size in bytes from
 * [[HoconInput]] in a [[com.avsystem.commons.serialization.GenCodec GenCodec]] implementation, taking advantage of the
 * [[https://github.com/lightbend/config/blob/master/HOCON.md#size-in-bytes-format HOCON format for size in bytes]],
...
/**
 * [[com.avsystem.commons.serialization.TypeMarker TypeMarker]] which allows direct reading of a `Period` from
 * [[HoconInput]] in a [[com.avsystem.commons.serialization.GenCodec GenCodec]] implementation, taking advantage of the
 * [[https://github.com/lightbend/config/blob/master/HOCON.md#period-format HOCON format for period]], implemented by
 * `Config.getPeriod`.
 */
object PeriodMarker extends HoconTypeMarker[Period]

/**
 * [[com.avsystem.commons.serialization.TypeMarker TypeMarker]] which allows direct reading of a `TemporalAmount` from
 * [[HoconInput]] in a [[com.avsystem.commons.serialization.GenCodec GenCodec]] implementation, taking advantage of the
 * [[https://github.com/lightbend/config/blob/master/HOCON.md#period-format HOCON format for period]], implemented by
 * `Config.getTemporal`.
 */
