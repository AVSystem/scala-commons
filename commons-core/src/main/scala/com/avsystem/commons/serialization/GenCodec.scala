...
object GenCodec extends RecursiveAutoCodecs with TupleGenCodecs {
  ...
  implicit lazy val BigIntCodec: GenCodec[BigInt] = createNullable(i => BigInt(i.readBigInteger()), (o, v) => o.writeBigInteger(v.bigInteger))
  implicit lazy val BigDecimalCodec: GenCodec[BigDecimal] = createNullable(i => BigDecimal(i.readBigDecimal()), (o, v) => o.writeBigDecimal(v.bigDecimal))
  ...
  implicit lazy val JBigIntegerCodec: GenCodec[JBigInteger] = createNullable(_.readBigInteger(), _ writeBigInteger _)
  implicit lazy val JBigDecimalCodec: GenCodec[JBigDecimal] = createNullable(_.readBigDecimal(), _ writeBigDecimal _)
