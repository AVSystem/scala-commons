...
import com.avsystem.commons.rest.{HeaderValue, HttpBody, QueryValue, RestRequest, RestResponse}
...
object RestClient {
  def asHandleRequest(client: HttpClient, baseUrl: String): RestRequest => Future[RestResponse] = request => {
