...
/**
  * Base class for companion objects of wrappers ("newtypes") over BSON [[ObjectId]] - the default type of
  * MongoDB document ID.
  * These wrappers usually serve to make the code more readable and typesafe. Because they are "transparent",
  * wrapping is not visible in any way after serialization.
  *
  * Example:
  * {{{
  *   import org.bson.types.ObjectId
